# 经文显示核心控件：统一背景、字体、底注、滚动，并支持稳定的左右边距
import os
...
class ScriptureDisplay(QWidget):
    ...
    def _set_adaptive_title(self,text):
        ...
        self.title_bar.setMinimumHeight(title_height); self.title_bar.setMaximumHeight(title_height); self.title_bar.setFont(font)
    ...
    def apply_settings(self,settings):
        ...
        self._update_viewport_margins(); self.footer_label.raise_(); self.set_verse_segmentation(bool(settings.get("verse_segmentation",False)))
